...
door.position.y = 1
// z fighting occurs when two objects are in the same position
...
hosue.add(bush1, bush2, bush3, bush4)
...
// Directional light
const moonLight = new THREE.DirectionalLight('#b9d5ff', 1.3)
